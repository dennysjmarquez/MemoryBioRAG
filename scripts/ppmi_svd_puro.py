...
from core.pmi_semantico import _tokenizar  # misma tokenización que el resto del proyecto

DEFAULT_ORIGEN = ROOT / 'MemoryBioRAG_Data' / 'memory_biorag.db'
DEFAULT_DB = ROOT / 'scripts' / 'ppmi_svd_puro' / 'ppmi_svd_vectors.db'
...
def main():
    ...
    if args.eval:
        ...
        out = db_path.parent / 'ppmi_svd_eval.json'
