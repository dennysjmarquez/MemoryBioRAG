...
class SQLiteMemoryBioRAG:
    ...
    def __init__(self, db_path=None):
        ...
        # v26.1: Neocórtex de Sangre y ADN Conceptual
        self.neocortex = None
...
# --- Migración v20.0 (Valencia Somática y Dopamina RPE) ---
    ...
    def buscar_por_frase(self, frase, profundidad="activos", pagina=1, limite=None, categoria=None, preview_chars=1500, historial_fallos=None, context_window=0, dimensiones_dict=None, dimensiones_ids=None, parafrasis_list=None, desde_ts=None, hasta_ts=None, modo_estricto=False, usar_inferencia=True, buscar_por_rol=None, ignore_peso_sinaptico=False, ordenar_por="relevancia"):
        ...
        # v26.1: Neocórtex de Sangre — Evaluación Epistémica
        if self.neocortex and frase.strip() and not modo_estricto:
            try:
                # El neocórtex lanza EpistemicUncertaintyError si "sabe que no sabe"
                self.neocortex.evaluar_episteme(frase)
            except Exception as e:
                # Lanza el error explícitamente para cumplir con "Cero Resultados Silenciosos"
                # Solo si no es una búsqueda técnica forzada
                if "EpistemicUncertaintyError" in str(type(e)):
                    raise e
                logger.warning(f"Aviso Epistémico: {e}")
