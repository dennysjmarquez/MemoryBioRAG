...
| **Reciprocal Rank Fusion (RRF)** | Cormack, Clarke & Buettcher (2009) | `core/ppmi_hybrid_search.py` | Fusionar de forma robusta los ránkings de búsqueda léxica FTS5 y búsqueda espectral SVD sin distorsión de escalas de scoring numéricas. |
...
| **Inhibición lateral GABA en tiempo real** | Edelman (1987) | `core/memory_store.py` — `buscar_por_frase()` | Cuando un resultado domina claramente la búsqueda, atenuar a sus competidores del mismo nicho semántico para reducir ruido, sin usar vectores densos. |
