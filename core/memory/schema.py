"""
Módulo de esquema de base de datos SQLite, DDL, migraciones, catálogo dimensional y FTS5.

Extraído de SQLiteMemoryBioRAG (Paso 3.4f - T18).
Excepción de límite de líneas por deuda técnica documentada: _crear_estructura_cerebral
se traslada intacta (513 líneas) para preservar la inicialización atómica del esquema DDL sin reescritura.
"""
