...
=====================
Pipeline de búsqueda híbrida: FTS5 trigram + BM25 + co-ocurrencia PPMI/SVD +
dimensiones semánticas + resonancia sináptica + calibración epistémica.

Extraído de SQLiteMemoryBioRAG (memory_store.py) como parte de la
...
logger = logging.getLogger('BioRAG.Search')
