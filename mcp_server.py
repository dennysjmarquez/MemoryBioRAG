...
def _build_server():
    ...
    @mcp.tool(
        ...
        description=(
            ...
            "NO la mandés directo al motor. Primero PENSÁ:\n"
            "  ¿Cuál es la FORMA del problema que describe? ¿Qué patrón es?\n"
            "  ¿Qué propiedades tiene la solución que busca (aunque no sepa el nombre técnico)?\n"
            "  ¿Qué palabras DISTINTAS a las suyas describen el mismo concepto?\n\n"
            "Si la búsqueda literal devuelve 0 resultados, NO significa que no exista.\n"
            "Significa que el humano usó palabras distintas a las que están en la memoria.\n"
            "Tu trabajo es encontrar el PUENTE entre su vocabulario y el vocabulario del nodo.\n\n"
            "EJEMPLO del principio en acción:\n"
            "  Humano pregunta: 'interfaz que destruye y recrea secciones, validador aleatorio'\n"
            "  Búsqueda literal → 0 resultados (esas palabras no están en la DB)\n"
            "  Razonamiento correcto:\n"
            "    'destruye y recrea' = ciclo montar/desmontar de componentes\n"
            "    'validador aleatorio de instanciación' = identificador único al crear (UUID)\n"
            "    'impidiendo duplicados' = deduplicación por ID\n"
            "  → Buscar por la FORMA (persistencia, instancia única, componentes) → resultado correcto\n\n"
            "El humano no sabe el nombre técnico. Tu trabajo es reconocer el patrón,\n"
            "no solo hacer coincidir keywords.\n\n"
            "═══════════════════════════════════════════════════════\n"
