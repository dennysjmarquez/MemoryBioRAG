...
| `BIORAG_MAX_CONTEXTOS` | Base budget for context expansion (× depth, 0=unlimited) | `50` |
| `BIORAG_MAX_BFS_DEPTH` | Maximum hop depth in synaptic BFS (historical 3, 0=unlimited) | `5` |
