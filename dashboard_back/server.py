...
DB_PATH = os.path.join(PARENT_DIR, "MemoryBioRAG_Data", "memory_biorag.db")
...
def serve_index():
    ...
    return HTMLResponse(content="<h1>BioRAG Neuro-Visor v2</h1><p>Dashboard en construcción. Ve a /docs para ver los endpoints.</p>")
